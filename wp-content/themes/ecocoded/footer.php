	...
	<div class="content-wrap">
		...
		<div class="site-info">
			...
			<span class="footer-info-right">
				<?php echo __(' | WordPress Theme:', 'ecocoded') ?> <a href="<?php echo esc_url('https://superbthemes.com/ecocoded/', 'ecocoded'); ?>" rel="nofollow noopener"><?php echo __(' EcoCoded', 'ecocoded') ?></a>
			</span>
